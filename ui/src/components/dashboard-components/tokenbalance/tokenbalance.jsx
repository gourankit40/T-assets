...
const [modalpay, setModalpay] = useState(false);
    ...
    return (
       ...
       <Col sm="4" className="text-left">
        <p className="profilehead">Token Issued</p>
         ...
         <Col sm="8" className="text-right">
          ...
          />{' '}
            ...
            <TableCell className={classes.tableHeaderCell}>Issuer</TableCell>
            <TableCell className={classes.tableHeaderCell}>Issue Date</TableCell>
            ...
            <TableCell className={classes.tableHeaderCell}>Confirm</TableCell>
            <TableCell className={classes.tableHeaderCell}>Tenor</TableCell>
            <TableCell className={classes.tableHeaderCell}>Repayment Date</TableCell>

            <TableCell className={classes.tableHeaderCell}>Discount Factor</TableCell>
            <TableCell className={classes.tableHeaderCell}>Present Value</TableCell>
...
<TableCell className="chkp">
       ...
       <Col sm="4" className="text-left">
        <span className="profilehead">Token Reciever</span>
